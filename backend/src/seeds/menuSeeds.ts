...
export async function seedMenuItems() {
  ...
  const menuItems = [
    ...
    
    {
      ...
      photoUrl: 'https://images.unsplash.com/photo-1594736797933-d0e6914c6f7c?w=400',
      preparationTimeMin: 4,
      costOfGoods: 1.50,
      allergens: [],
      qtyOnHand: 70,
    ...
    
    {
      ...
      photoUrl: 'https://images.unsplash.com/photo-1553787499-6d7ad2cda6c6?w=400',
      preparationTimeMin: 2,
      costOfGoods: 1.25,
      allergens: ['soy'],
      qtyOnHand: 95,
    ...
    
    {
      ...
      photoUrl: 'https://images.unsplash.com/photo-1527010154944-5b65a72c44f4?w=400',
