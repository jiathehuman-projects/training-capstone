...
describe('Order Calculations', () => {
  describe('calculateOrderTotals', () => {
    ...
    it('should calculate totals correctly for valid items', () => {
      const mockItems = [
        { unitPrice: 10.00, quantity: 2 } as OrderItem,
        { unitPrice: 15.50, quantity: 1 } as OrderItem,
      ];
    ...
    it('should handle items with null/undefined unitPrice', () => {
      const mockItems = [
        { unitPrice: null as any, quantity: 2 } as OrderItem,
        { unitPrice: undefined as any, quantity: 1 } as OrderItem,
        { unitPrice: 10.00, quantity: 2 } as OrderItem,
      ];
    ...
    it('should handle items with null/undefined quantity', () => {
      const mockItems = [
        { unitPrice: 10.00, quantity: null as any } as OrderItem,
        { unitPrice: 15.00, quantity: undefined as any } as OrderItem,
        { unitPrice: 20.00, quantity: 2 } as OrderItem,
      ];
    ...
    it('should handle NaN values', () => {
      const mockItems = [
        { unitPrice: NaN, quantity: 2 } as OrderItem,
        { unitPrice: 10.00, quantity: NaN } as OrderItem,
        { unitPrice: 15.00, quantity: 2 } as OrderItem,
      ];
    ...
    it('should handle mixed invalid and valid values', () => {
      const mockItems = [
        { unitPrice: null as any, quantity: undefined as any } as OrderItem,
        { unitPrice: NaN, quantity: NaN } as OrderItem,
        { unitPrice: 'invalid' as any, quantity: 'also invalid' as any } as OrderItem,
        { unitPrice: 25.75, quantity: 3 } as OrderItem,
      ];
    ...
    it('should round to 2 decimal places', () => {
      const mockItems = [
        { unitPrice: 10.999, quantity: 1 } as OrderItem,
        { unitPrice: 5.555, quantity: 2 } as OrderItem,
      ];
    ...
    it('should handle zero values correctly', () => {
      const mockItems = [
        { unitPrice: 0, quantity: 5 } as OrderItem,
        { unitPrice: 10.00, quantity: 0 } as OrderItem,
        { unitPrice: 15.00, quantity: 2 } as OrderItem,
      ];
